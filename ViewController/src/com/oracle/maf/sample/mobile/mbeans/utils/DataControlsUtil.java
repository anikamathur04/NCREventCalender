...
public class DataControlsUtil {
   ...
   /**
     ...
     */
   public static final Object invokeOnDataControl(String methodName, 
      ...
      {
        System.out.println(paramNames.get(index));
      }
      System.out.println("paramValues ->");
      for (int index = 0; index < paramValues.size(); index++)
      {
        System.out.println(paramValues.get(index));
      }
      System.out.println("paramTypes->");
      for (int index = 0; index < paramTypes.size(); index++)
      {
        System.out.println(paramTypes.get(index));
      }
      System.out.println("#################################################");
//        logger.logFine(message, 
//                       "com.oracle.maf.sample.mobile.mbeans.utils.DataControlsUtil", "invokeOnDataControl");
        try {            
